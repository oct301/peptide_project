...
path_train_data='./data/real_train_data.tfrecords'
path_valid_data='./data/real_valid_data.tfrecords'
...
#save checkpoint
checkpoint_path = "./checkpoints/just_train"
...
while True:
    ...
    if (epoch + 1) % 5 == 0:
        ...
        print('wr', f'Saving checkpoint for epoch {epoch + 1} at {ckpt_save_path}')
